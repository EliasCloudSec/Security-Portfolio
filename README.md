# Security-Portfolio Elias Perez

Documented cloud security investigations, built in a live Azure tenant
(Mad Hat Labs, a multi-user training environment).

Target role: SOC Analyst / Security Analyst/ Network Admin
Currently: T-Mobile | Irvine
Contact: Elias94perez@hotmail.com · https://www.linkedin.com/in/elias-perez-bb14731b3/

## Investigations
| # | Title | Focus | Write-up |
|---|-------|-------|----------|
| 1 | Operation Dead Deploy | Governance forensics, deployment audit trail | [Operation Dead Deploy](./Operation-Dead-Deploy/) |
